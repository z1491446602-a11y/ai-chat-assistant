...
export function createServerConfig(rootDir) {
  ...
  const config = {
    ...
    MEDIA_TASK_MAX_CONCURRENCY: readPositiveInteger('MEDIA_TASK_MAX_CONCURRENCY', 5),
    IMAGE_TASK_MAX_CONCURRENCY: readPositiveInteger('IMAGE_TASK_MAX_CONCURRENCY', 5),
